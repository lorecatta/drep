...
Second, let's assume that all four infections are infectious but symptomatic infections are twice as infectious as asymptomatic ones. This requires knowledge of the proportion of primary. secondary and tertiary/quaternary infections which are asymptomatic. We source the values of these parameters from [Ferguson et al. 2016](https://science.sciencemag.org/content/353/6303/1033) and put them in a vector.
