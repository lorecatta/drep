...
```{r}
n_cases <- drep::calculate_cases(lambda, n_j, u_lim, l_lim, prop_sym_parms, pop_size)
n_cases
```

and the number of hospitalized cases:

```{r}
n_h_cases <- drep::calculate_hosp_cases(lambda, n_j, u_lim, l_lim, hosp_weights, prop_sym_parms, pop_size)
n_h_cases
```
