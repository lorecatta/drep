test_that("R0_3 calculation is correct", {
  ...
  R0_3 <- purrr::pmap(foi[, c("FOI", "population", "ID_0")],
  ...
  R0_3_vec <- unlist(R0_3)

  expect_equal(R0_3_vec, correct_outputs$R0_3, tolerance = 1e-10)
