test_that("R0_2 calculation is correct", {
  ...
  R0_2 <- purrr::pmap(foi[, c("FOI", "population", "ID_0")],
  ...
  R0_2_vec <- unlist(R0_2)

  expect_equal(R0_2_vec, correct_outputs$R0_2, tolerance = 1e-10)
